...
CONFIG_FILE='super8coin.conf'
CONFIGFOLDER='/root/.super8coin'
COIN_DAEMON='/usr/local/bin/super8coind'
COIN_CLI='/usr/local/bin/super8coin-cli'
COIN_REPO='https://github.com/AstaClover/Super8/releases/download/v.1.0/super8.tar.gz'
COIN_NAME='super8Coin'
COIN_PORT=8797
...
function compile_node() {
  ...
  cp super8coin* /usr/local/bin >/dev/null 2>&1
  compile_error
